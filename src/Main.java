...
public class Main {
    public static void main(String[] args) {
       ...
       //sistema.addUsuario(si);sistema.addUsuario(h);sistema.addUsuario(m);sistema.addUsuario(t);sistema.addUsuario(c);sistema.addUsuario(f);
       ...
       sistema.addViaje(v1);sistema.addViaje(v2);sistema.addViaje(v3);sistema.addViaje(v4);sistema.addViaje(v5);sistema.addViaje(v6);sistema.addViaje(v7);sistema.addViaje(v8);
